 ...
 * Generated for Laravel 5.6.1 on 2018-05-07 10:35:37.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
        ...
        public static function spy()
        {
            ...
            \Illuminate\Support\Facades\Auth::spy();
        }
         ...
         *
         * @param mixed $id
         * @return \App\Models\Db\User|false
         * @static 
         */ 
    ...
    class Schema {
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
            \Illuminate\Support\Facades\Schema::spy();
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
            return \Illuminate\Support\Facades\Schema::shouldReceive();
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
            \Illuminate\Support\Facades\Schema::swap($instance);
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
            \Illuminate\Support\Facades\Schema::clearResolvedInstance($name);
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
            return \Illuminate\Support\Facades\Schema::getFacadeApplication();
        }
...
namespace App\Components\handbook\Facades { 
    ...
    class Handbook {
        ...
        {
            return \App\Components\handbook\Handbook::get($name);
        }
        ...
        {
            return \App\Components\handbook\Handbook::getList($id);
        }
         ...
         * @return \App\Components\handbook\HandbookData 
         * @throws NotFoundHttpException
         * @static 
         */ 
        public static function getRecord($name, $data_id)
        {
            return \App\Components\handbook\Handbook::getRecord($name, $data_id);
        }
         ...
         * @static 
         */ 
        public static function getChildData($childName, $parentDataId)
        {
            return \App\Components\handbook\Handbook::getChildData($childName, $parentDataId);
        }
        ...
        {
            \App\Components\handbook\Handbook::setToCache();
        }
        ...
        {
            \App\Components\handbook\Handbook::readFromCache();
        }
...
namespace  { 
    ...
    class Handbook extends \App\Components\handbook\Facades\Handbook {}
